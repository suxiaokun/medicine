          ...
          <td colspan="2" align="left" valign="top">
		    	...
		    	<table border="0" class="tb1">
			        ...
			        <tr>
			          ...
			          <td><html:text property="username"  styleClass="it"/></td>
			        </tr>
			        <tr>
			          <td align="right"><bean:message key="user.password"/>£º</td>
			          <td><html:password property="password"  styleClass="it"/></td>
			        </tr>
			        <tr>
			          <td colspan="2" align="center" height="30" style="padding-left:10px">
...
<!--			         	 </html:reset>-->
               <input type="reset" class="button" value="<bean:message key="button.reset" />" />
